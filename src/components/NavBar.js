      ...
      <ul className="flex flex-col overflow-hidden">
        <nav className="bg-gradient-to-r from-purple-400 via-pink-500 to-red-500 flex flex-col h-screen px-4 text-white rounded-r-3xl">
          ...
          {selectedHomeState === true ? (
            <li
              className="text-center py-2 border-r-8 w-72 flex p-3 space-x-4 mt-0.5 justify-center cursor-pointer my-2"
            ...
            <li
              className="text-center py-2 w-72 text-center py-2 flex p-3 space-x-4 mt-0.5 justify-center cursor-pointer my-2"
              onClick={goToWelcomeBtn}
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
          ...
          {selectedAccState === true ? (
            ...
            <li
              className="text-center py-2 text-center w-72 py-2 flex p-3 space-x-4 mt-0.5 justify-center cursor-pointer my-2"
              onClick={goToAccounts}
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
          ...
          {selectedMathBtnState == true && selectedEngBtnState == false ? (
            ...
            <li
              className="text-center py-2 w-72 flex p-3 space-x-4 mt-0.5 justify-center cursor-pointer my-2"
              onClick={MathBtn}
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
